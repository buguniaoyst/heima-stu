            ...
            <ul class="layui-nav admin-header-item">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" class="admin-header-user">
                        ...
                        <span style="color: #1aa094">您好!&nbsp; 欢迎您！</span>
                    </a>
                </li>
                <li class="layui-nav-item">
                    <a href="${pageContext.request.contextPath}/rest/login" class="admin-header-user">
                        <i class="layui-icon" style="font-size: 30px; color: #1aa094;">&#xe612;</i>
                       <span style="color: #1aa094;font-size: small">立即登录</span>
                    </a>
                </li>
            </ul>
